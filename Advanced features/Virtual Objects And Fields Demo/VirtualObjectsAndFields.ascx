<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VirtualObjectsAndFields.ascx.vb" Inherits="Virtual_Objects_And_Fields.Samples.VirtualObjectsAndFields" %>
...
/>
<div id="all">
	<div class="header block-flat">This example demonstrates creation and using of virtual database objects and fields.
