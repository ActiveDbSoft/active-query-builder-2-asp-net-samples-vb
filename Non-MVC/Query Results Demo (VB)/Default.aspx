<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="Samples.Default" %>
...
<body>
    <form id="Form1" runat="server">
        ...
        function showTransformedSQL() {
            QB.Web.Application.syncCriteriaBuilder(function () {
                $("#transformedSql").html(QB.Web.Application.QueryTransformerSQL);
                $("#transformedSql").dialog({
                    modal: true,
                    buttons: {
                        Ok: function () {
                            $(this).dialog("close");
        ...
        <div id="tabs">
                                ...
                                <div class="qb-ui-canvas-container block-flat">
                                    ...
                                    <div id="qb-ui-editor-statusbar">
                                        ...
                                        <div id="qb-ui-editor-statusbar-controls">
                                            <input type="button" value="Refresh" id="qb-ui-editor-controls-refresh" name="qb-ui-editor-controls-refresh">
                                            <input type="button" value="Reconnect" id="qb-ui-editor-controls-reconnect" name="qb-ui-editor-controls-reconnect">
            ...
            <div id="queryResults">
                ...
                <input type="button" onclick="if (QB.Web.Application.CriteriaBuilder.isValid()) { executeQuery(); } else { alert('Criteria builder is not valid!'); }" value="Update results">
                <input type="button" onclick="showTransformedSQL();" value="Show transformed SQL"><div id="transformedSql" style="display: none"></div>
                <br />
                <br />
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" EnableViewState="false">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="dataGridView1" runat="server" EnableViewState="false" AllowPaging="True" AllowSorting="True" EnableSortingAndPagingCallbacks="True"></asp:GridView>
                    </ContentTemplate>
                    <Triggers>
