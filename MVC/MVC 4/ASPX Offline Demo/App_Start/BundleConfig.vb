...
Public Class BundleConfig
	...
	Public Shared Sub RegisterBundles(bundles As BundleCollection)
		...
		bundles.Add(New ScriptBundle("~/bundles/ActiveQueryBuilder").Include(String.Format("~/js/release/usr_v{0}.js", ActiveDatabaseSoftware.ActiveQueryBuilder.Web.Control.QueryBuilderControl.VersionString)))


		bundles.Add(New StyleBundle("~/css/ActiveQueryBuilder").Include("~/css/qb-theme.css", "~/css/themes/jquery-ui.css"))
